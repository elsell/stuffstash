...
- Settings working pass: mobile/API-client TypeScript checks, 145 mobile test files / 1019 tests and 34 API-client tests pass; mobile structural check passes. This is source evidence, not a native build or end-to-end device check.
