...
- Mutation graph working pass: mobile TypeScript check and 143 test files / 1012 tests pass; mobile structural check passes. This is source evidence, not a native build or end-to-end device check.
