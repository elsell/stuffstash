...
the audit plan. Consume the already-running35803226783 result once; then prioritize
concrete corrections and unchanged user-workflow acceptance. Keep diagnostic-only
