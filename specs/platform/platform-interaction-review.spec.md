...
Photo inspection reuses the native action-menu adapter with an explicit on-dark canvas tone; other menu consumers keep their existing appearance. Metadata is read-only menu content.
