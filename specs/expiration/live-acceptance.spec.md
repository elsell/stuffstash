...
The corresponding Flash-Lite expiration cases passed four of eight: all three dated creates and ambiguity failed (`/tmp/expiration-native-flat-lite.log`). This comparison does not change configured provider choices. The accepted projection addresses demonstrated Flash command-selection failures; it does not establish reliable Flash-Lite expiration handling, physical-device acceptance, or completed release.
