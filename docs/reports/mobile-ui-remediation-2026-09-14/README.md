...
The release hold remains open for Move's visual acceptance. Frozen PR174 covers
M274–M279: filter navigation/density, retained search, contextual detail actions and
...
CI35945384623 passed. Finish remaining Add capture review before merging.
...
long command labels and the wider surface audit remain open. These subsequent
candidates do not silently expand PR174's frozen scope.
