...
- `native-fixtures-350633.md`: phone57/79, passing Home tab return/action probes and invitation acceptance; inspected Account notice contradicts geometry timeout; tablet result pending.
