...
| Move | 35917033325 passes all four Move workflows on phone and iPad. Reviewed phone/iPad selection and recovery have aligned native sections, visible search and reachable actions. | Creation still has inconsistent custom panel styling. Grouped Name/Kind correction is implemented with 53 focused tests and critic pass; final native visual review remains open. |
