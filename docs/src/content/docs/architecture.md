...
The current API slice proves this boundary with local development auth, OIDC token verification, SpiceDB authorization wiring, tenant and inventory management, asset creation and movement, custom asset types, custom fields, audit history, asset attachments, direct inventory sharing, and Huma-generated OpenAPI.
