...
The current API slice proves this boundary with local development auth, OIDC token verification, SpiceDB authorization wiring, tenant creation, inventory creation and listing, direct inventory sharing, and Huma-generated OpenAPI.
