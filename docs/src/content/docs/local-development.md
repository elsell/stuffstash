...
The app is still early. Today, you can run the Go API, create tenants, create inventories, create and list assets, persist them in Postgres through Compose, and test the first auth boundary.
...
You can run the same tenant, inventory, and asset flow as a check:
