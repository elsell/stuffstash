...
class FixtureRouteIsolationTests(unittest.TestCase):
    ...
    def test_retains_production_routes_and_installs_only_fixture_exports(self):
        ...
        self.assertEqual({p.name for p in self.routes.iterdir()} - {"search.tsx", "browse-filters.tsx", "expiration.tsx", "audit-browse-journey.tsx", "assets", "audit-edit-journey.tsx", "audit-android-header-composition.tsx", "audit-notifications.tsx", "audit-notification-target.tsx", "audit-managed-search.tsx", "audit-contents-search-preconfigured.tsx", "audit-tabs", "audit-invitation.tsx", "audit-customization-editor.tsx", "audit-settings-readback.tsx", "voice.tsx", "voice-plan-location.tsx", "audit-native-search-placement.tsx", "add.tsx", "settings.tsx"},
        ...
        self.assertEqual({str(p.relative_to(self.routes)) for p in (self.routes / "audit-tabs").rglob("*.tsx")},
                         {*[p.replace("(tabs)/", "audit-tabs/", 1) for p in self.tab_layouts], "audit-tabs/(home)/index.tsx", "audit-tabs/(search)/search.tsx", "audit-tabs/(home,search)/assets/[assetId]/index.tsx", "audit-tabs/(home,search)/settings/inventory/tags/[resourceId].tsx"})
