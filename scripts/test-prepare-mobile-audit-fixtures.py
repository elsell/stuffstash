...
class FixtureRouteIsolationTests(unittest.TestCase):
    ...
    def test_retains_production_routes_and_installs_only_fixture_exports(self):
        ...
        self.assertEqual({p.name for p in self.routes.iterdir()} - {"audit-customization-editor.tsx", "voice.tsx", "voice-plan-location.tsx", "audit-native-search-placement.tsx", "add.tsx", "settings.tsx"},
