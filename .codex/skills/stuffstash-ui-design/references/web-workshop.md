...
Use for substantial new web direction. Existing user instructions and approvals
supply the decision gate; do not ask repeatedly for routine implementation choices.
This mode does not apply to mobile work or read-only audits.
