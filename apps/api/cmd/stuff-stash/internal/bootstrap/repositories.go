...
type repositories struct {
	...
	evaluationRuns             ports.EvaluationRunRepository
	...
	blobDeletionRechecks       ports.BlobDeletionRechecks
	...
	thumbnailBackfill          ports.ThumbnailBackfill
