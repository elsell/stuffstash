...
type Dependencies struct {
	PushSender  ports.NotificationPushSender
	Deliveries  ports.NotificationDeliveryRepository
	Devices     ports.NotificationDeviceRepository
	PushTokens  ports.NotificationPushTokenValidator
