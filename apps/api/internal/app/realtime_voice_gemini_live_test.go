...
func TestGoogleGeminiLiveRealisticVoiceCorpus(t *testing.T) {
	...
	cases := []liveGeminiVoiceCorpusCase{
		...
		},
		{
			...
			expect:     liveGeminiVoiceExpectPlan,
			assertPlan: assertLiveGeminiVoiceSingleExistingAssetPlan(actionplan.CommandKindArchiveAsset, "archive", "Garden shears"),
		},
		{
			name:       "restore archived item",
			transcript: "Restore the old modem.",
			expect:     liveGeminiVoiceExpectPlan,
			assertPlan: assertLiveGeminiVoiceSingleExistingAssetPlan(actionplan.CommandKindRestoreAsset, "restore", "Old modem"),
		},
		{
			name:       "checkout existing item",
			transcript: "Check out the garden shears. I'm using them in the yard.",
			expect:     liveGeminiVoiceExpectPlan,
			assertPlan: assertLiveGeminiVoiceSingleExistingAssetPlan(actionplan.CommandKindCheckoutAsset, "checkout", "Garden shears"),
		},
		{
			name:       "return checked out item",
			transcript: "Return the loaner flashlight.",
			expect:     liveGeminiVoiceExpectPlan,
			assertPlan: assertLiveGeminiVoiceSingleExistingAssetPlan(actionplan.CommandKindReturnAsset, "return", "Loaner flashlight"),
		},
		{
