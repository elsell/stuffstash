...
func TestSpiceDBIntegrationEnforcesTenantAndInventoryRelationships(t *testing.T) {
	...
	assertAllowed(t, authorizer.CheckInventory(ctx, ownerOne, ports.InventoryPermissionViewImportJob, inventoryOneID), "tenant owner can view import jobs")
	assertAllowed(t, authorizer.CheckInventory(ctx, ownerOne, ports.InventoryPermissionCreateImportJob, inventoryOneID), "tenant owner can create import jobs")
	...
	assertAllowed(t, authorizer.CheckInventory(ctx, inventoryOwner, ports.InventoryPermissionViewImportJob, inventoryOneID), "inventory owner can view import jobs")
	assertAllowed(t, authorizer.CheckInventory(ctx, inventoryOwner, ports.InventoryPermissionCreateImportJob, inventoryOneID), "inventory owner can create import jobs")
	...
	assertAllowed(t, authorizer.CheckInventory(ctx, inventoryEditor, ports.InventoryPermissionViewImportJob, inventoryOneID), "inventory editor can view import jobs")
	assertAllowed(t, authorizer.CheckInventory(ctx, inventoryEditor, ports.InventoryPermissionCreateImportJob, inventoryOneID), "inventory editor can create import jobs")
	...
	assertForbidden(t, authorizer.CheckInventory(ctx, inventoryViewer, ports.InventoryPermissionViewImportJob, inventoryOneID), "inventory viewer cannot view import jobs")
	assertForbidden(t, authorizer.CheckInventory(ctx, inventoryViewer, ports.InventoryPermissionCreateImportJob, inventoryOneID), "inventory viewer cannot create import jobs")
