...
func TestMixedTextAudioContinuityRetainsAnswerContextAndEndsAtLimit(t *testing.T) {
	...
	for turn := 0; turn < 3; turn++ {
		if turn == 1 {
			writeRealtimeMessage(t, ctx, connection, map[string]any{"type": "text.input", "seq": 4, "sessionId": sessionID, "text": "Which ones?"})
		} else {
