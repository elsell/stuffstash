...
func RegisterCreateInventory(api huma.API, application app.App) {
	huma.Post(api, "/tenants/{tenantId}/inventories/{inventoryId}/custom-field-definitions", func(ctx context.Context, input *dto.CreateInventoryDefinitionInput) (*dto.CreateDefinitionOutput, error) {
