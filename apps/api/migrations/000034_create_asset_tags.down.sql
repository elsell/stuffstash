...
WHERE action IN ('asset_tag.created','asset_tag.listed','asset_tag.updated','asset_tag.archived')
   OR target_type = 'asset_tag';

DROP TABLE IF EXISTS asset_tag_assignments;
