CREATE TABLE notification_inbox (
 ...
 expiration_precision VARCHAR(8) NOT NULL CHECK (expiration_precision IN ('day','month')),
 kind VARCHAR(16) NOT NULL CHECK (kind IN ('upcoming','expired')),
 created_at TIMESTAMPTZ NOT NULL,
 read_at TIMESTAMPTZ,
 CONSTRAINT idx_notification_milestone UNIQUE (tenant_id, inventory_id, principal_id, asset_id, expiration_date, expiration_precision, kind)
);
CREATE INDEX idx_notification_inbox_scope ON notification_inbox (tenant_id, inventory_id, principal_id, id DESC);
