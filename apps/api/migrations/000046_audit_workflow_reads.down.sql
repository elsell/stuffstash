-- Preserve historical workflow read actions after downgrade.
...
ALTER TABLE audit_records ADD CONSTRAINT chk_audit_records_action CHECK (action IN (
  ...
  'conversation_workflow.revision_created','conversation_workflow.activated',
 'conversation_workflow.viewed',
 'conversation_workflow.listed','conversation_evaluation_case.revision_created','conversation_evaluation_case.viewed','conversation_evaluation_case.listed','conversation_evaluation_run.created','conversation_evaluation_run.progressed','conversation_evaluation_run.cancelled','conversation_evaluation_run.viewed','conversation_evaluation_run.listed',
