...
CREATE TABLE conversation_workflow_revisions (
 ...
 created_at TIMESTAMPTZ NOT NULL,
 PRIMARY KEY (tenant_id,workflow_id,id),
 CONSTRAINT workflow_revision_sequence UNIQUE (tenant_id,workflow_id,number),
 FOREIGN KEY (tenant_id,workflow_id) REFERENCES conversation_workflows(tenant_id,id) ON UPDATE CASCADE ON DELETE RESTRICT
);
