...
ALTER TABLE audit_records ADD CONSTRAINT chk_audit_records_action CHECK (action IN (
  ...
  'conversation_workflow.revision_created','conversation_workflow.activated','conversation_evaluation_case.revision_created','conversation_evaluation_case.viewed','conversation_evaluation_case.listed',
