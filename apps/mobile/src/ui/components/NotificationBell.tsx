...
export function NotificationBell({ tenantId, inventoryId, initialize, count, onOpen }: {
  ...
  return <Pressable accessibilityRole="button" accessibilityLabel={label} onPress={() => { if (registration.isError) void registration.refetch(); if (registration.isSuccess) void unread.refetch(); onOpen(); }} style={styles.button}>
