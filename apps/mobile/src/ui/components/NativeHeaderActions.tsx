...
import { Bell, Plus, UserCircle, X, Check, CheckCheck, Settings } from 'lucide-react-native';
import { Pressable, View } from 'react-native';
import type { HeaderOptions, NativeHeaderAction } from './NativeHeaderActions.types';
const icons = { notifications: Bell, add: Plus, account: UserCircle, close: X, save: Check, settings: Settings, 'mark-read': CheckCheck };
