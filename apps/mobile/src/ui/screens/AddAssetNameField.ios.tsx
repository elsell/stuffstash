...
import type { AddAssetNameFieldProps } from './AddAssetNameField.types';

export function AddAssetNameField({ value, editable, accessibilityLabel: label, placeholder, onChangeText }: AddAssetNameFieldProps) {
