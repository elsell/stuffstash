...
import type { VoiceInteractionState } from './VoiceInteractionStateContext';
import { buildVoiceSessionPresentation } from './VoiceSessionPresentation';

type VoiceSessionOverlayProps = {
          ...
          {state.status === 'loading' ? (
            ...
            <ScrollView contentContainerStyle={styles.sessionContent}>
              <View style={styles.primaryControlRow}>
                <Pressable
                  accessibilityLabel={state.stage === 'listening' ? 'Stop listening' : 'Start another voice interaction'}
                  accessibilityRole="button"
