import { usePullRefresh } from '../ui/serverState/usePullRefresh';
...
export default function ExpirationRoute() {
 ...
 const pullRefresh = usePullRefresh(async () => { if (inventory.isError) await inventory.refetch(); else if (matches) await state.refetch(); });
