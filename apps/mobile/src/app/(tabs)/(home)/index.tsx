...
export default function HomeRoute() {
  ...
  return <NotificationHomeEntry renderAction={notificationAction => <HomeScreen refreshingAdditional={refreshingExpiration > 0} onRefreshAdditional={refreshExpiration} expirationSection={<ExpirationHomeEntry />} notificationAction={notificationAction} assetCheckoutCommand={assetCheckoutCommand} dashboardQuery={homeDashboardQuery} />} />;
}
