export type WorkspaceEventName =
  ...
  | 'workspace.import_preview_started'
  | 'workspace.import_preview_completed'
  | 'workspace.import_preview_failed'
  | 'workspace.import_apply_started'
  | 'workspace.import_apply_completed'
  | 'workspace.import_apply_failed'
